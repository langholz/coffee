...
Using `csvdiff`[^8], the changes performed at each stage can be [calculate](#calculate_csv_diff_summaries) per each file by the amount rows that were either removed, added and/or changed. Using this metric, we can summarize as follows.
